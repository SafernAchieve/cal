/** @license
 * DayPilot Pro for JavaScript 2024.4.6294
 * Copyright 2005 - 2024 Annpoint, s.r.o.
...
export declare class DayPilotMonth extends React.Component<MonthProps> {
    control: DayPilot.Month;
}

export declare class DayPilotGantt extends React.Component<GanttProps> {
    control: DayPilot.Gantt;
}

export declare class DayPilotKanban extends React.Component<KanbanProps> {
    control: DayPilot.Kanban;
}

export declare class DayPilotNavigator extends React.Component<NavigatorProps> {
    control: DayPilot.Navigator;
}

export declare class DayPilotQueue extends React.Component<QueueProps> {
    control: DayPilot.Queue;
}

export declare class DayPilotBubble extends React.Component<BubbleProps> {
    control: DayPilot.Bubble;
}
...
export class MonthProps extends DayPilot.MonthConfig {
    controlRef?: React.MutableRefObject | ((component: DayPilot.Month) => void);
}

export class GanttProps extends DayPilot.GanttConfig {
    controlRef?: React.MutableRefObject | ((component: DayPilot.Gantt) => void);
}

export class KanbanProps extends DayPilot.KanbanConfig {
    controlRef?: React.MutableRefObject | ((component: DayPilot.Kanban) => void);
}

export class NavigatorProps extends DayPilot.NavigatorConfig {
    controlRef?: React.MutableRefObject | ((component: DayPilot.Navigator) => void);
}

export class QueueProps extends DayPilot.QueueConfig {
    controlRef?: React.MutableRefObject | ((component: DayPilot.Queue) => void);
}

export class BubbleProps extends DayPilot.BubbleConfig {
    controlRef?: React.MutableRefObject | ((component: DayPilot.Bubble) => void);
}
